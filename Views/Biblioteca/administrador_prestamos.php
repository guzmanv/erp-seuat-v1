        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">  <?= $data['page_title'] ?>
              <a href="NuevoPrestamo"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-md"></i> Nuevo</button></a>
            </h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-body">
                <div class="col-12 col-xl-12">
                  <div class="card">
                    <div class="card-body">
                      <h3 class="card-title">Lista de Préstamos de Libros</h3>
                      <p class="card-text">
