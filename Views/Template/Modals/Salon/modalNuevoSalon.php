    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header headerRegister">
                <h5 class="modal-title" id="titleModalNueva">Nuevo salón</h5>
                    ...
                    <form id="formModalidad" name="formModalidad">
                        ...
                        <div class="card-body"> 
                            <div class="form-group">
                                <label>Nombre de salón</label>
                                <input type="text" id="txtModalidadNueva" name="txtModalidadNueva" class="form-control form-control-sm" placeholder="EJ: Escolar" maxlength="30" required>
                            </div>
                            <!--
                            <div class="form-group">
                                <label>Estatus</label>
