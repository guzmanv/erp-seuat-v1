                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="txtClaveInstitucionNuevo" name="txtClaveInstitucionNuevo" class="form-control form-control-sm" placeholder="Clave de institución" maxlength="30">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Clave de DGP</label>
