	...
	public function Ingresos()
	{
		...
		public function getIngresos()
		{
			...
			for ($i=0; $i < count($arrData); $i++) {
				...
				<button class="btn btn-outline-secondary btn-xs icono-color-principal btnPermisosRol" onClick="fntPermisos('.$arrData[$i]['id'].')" title="Permisos"> &nbsp;&nbsp; <i class="fas fa-store icono-azul"></i> &nbsp; Servicios</button>
				<!--
				<div class="btn-group">
